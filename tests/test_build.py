...
def test_production_canonical_urls_do_not_repeat_base_path(tmp_path: Path) -> None:
    output = build_site(output=tmp_path / "site", base_url="/CapacityAtlas")
    ...
    assert 'href="https://tomasortega.github.io/CapacityAtlas/"' in home
    assert (
        'href="https://tomasortega.github.io/CapacityAtlas/problems/'
        'binary-symmetric-channel/"'
    ) in problem
    assert "/CapacityAtlas/CapacityAtlas/" not in home
    assert "/CapacityAtlas/CapacityAtlas/" not in problem
